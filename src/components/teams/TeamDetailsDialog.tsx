...
export function TeamDetailsDialog({ team, open, onOpenChange }: TeamDetailsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl w-[95vw] h-[90vh] max-h-[90vh] overflow-hidden flex flex-col p-4 sm:p-6">
        ...
        <Tabs defaultValue="overview" className="flex-1 overflow-hidden flex flex-col">
          <TabsList className="w-full grid grid-cols-3 h-auto p-1 mb-4">
            <TabsTrigger value="overview" className="text-xs sm:text-base py-2 px-1 sm:px-4">Overview</TabsTrigger>
            <TabsTrigger value="patterns" className="text-xs sm:text-base py-2 px-1 sm:px-4">Prediction Patterns</TabsTrigger>
            <TabsTrigger value="predictors" className="text-xs sm:text-base py-2 px-1 sm:px-4">Top Predictors</TabsTrigger>
          </TabsList>
